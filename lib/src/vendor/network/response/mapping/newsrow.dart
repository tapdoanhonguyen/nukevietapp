class NewListPaging {
  ...
  NewListPaging({this.total, this.data});

  factory NewListPaging.fromJson(Map<String, dynamic> json) => NewListPaging(
    total: json['total'],
    data: NewsRow.listFromJson(json['data']),
  );
}
...
class NewsRow {
  ...
  factory NewsRow.fromJson(Map<String, dynamic> json) => NewsRow(
    id: json["id"],
  ...
  static List<NewsRow> listFromJson(dynamic data) =>
      List<NewsRow>.from(data.map((x) => NewsRow.fromJson(x)));
}
